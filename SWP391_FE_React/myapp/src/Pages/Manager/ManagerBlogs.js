...
const ManagerBlogs = () => {
    ...
    //------------------------------------------------------------------------
    const resetForm = () => {
        setNewBlog({ accountId: "MAN1", title: "", content: "", image: null });
        setCurrentBlog(null);
                ...
                >
                    ...
                    {selectedBlog && (
                        <>
                            ...
                            >
                                {comments.length > 0 ? (
                                    comments.map((comment) => (
                                        ...
                                        >
                                            <ListItemText
                                                primary={`${comment.accountId === "MAN1" ? "Me" : comment.accountName
                                                    } (${comment.createDate})`}
                                                secondary={
                                                    <Box
                                                        sx={{
                            ...
                            {commentToEdit && commentToEdit.accountId === "MAN1" && (
